...
public class CmdGiveXpBottle implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if (expArg < P.p.getConfig().getInt("minimumexperience")) {
			MessageSender.sndCmdResponse(sender, "minimumexperience", " " + Integer.toString(P.p.getConfig().getInt("minimumexperience")));
			
			return true;
		}
		
		if (expArg > P.p.getConfig().getInt("maximumexperience")) {
			MessageSender.sndCmdResponse(sender, "maximumexperience", " " + Integer.toString(P.p.getConfig().getInt("maximumexperience")));
		...
		MessageSender.sndCmdResponse(sender, "bottlegiven", Integer.toString(expArg) + " EXP to " + playerArg.getName());
